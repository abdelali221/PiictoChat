...
typedef struct __attribute__((__packed__)) WD_BeaconDataHdr {
    uint32_t unk0;
    uint32_t unk1;
    ...
    uint16_t checksum;
    uint8_t unk4; // can either be current sequence id or
